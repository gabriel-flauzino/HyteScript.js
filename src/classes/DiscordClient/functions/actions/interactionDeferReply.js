module.exports = {
  description:
    'Sends "<client> is thinking..." status and makes interaction token don\'t expire. Note that it will make interaction as "replied", so to reply to the interaction you\'ll need to use #(interactionEditReply).',
  usage: "ephemeral?",
  parameters: [
    {
      name: "Ephemeral",
