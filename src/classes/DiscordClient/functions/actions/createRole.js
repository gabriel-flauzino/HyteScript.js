...
module.exports = {
  ...
  parameters: [
    ...
    },
    {
      name: "Options",
      description:
        "The options for create role. Read #(createRole) in HyteScript Docs for more details.",
      optional: "true",
      defaultValue: "none",
    },
    {
      ...
      optionsData.functions = new Functions(optionsData.functions)
        ...
        .set("setpermissions", {
          run: async (d, ...permissions) => {
            if (permissions[0] == undefined)
              return new d.error("required", d, "permissions");
            ...
            for (const permission of permissions) {
              ...
              if (!validPerms.includes(modPerm))
                return new d.error("invalid", d, "permission", permission);
        ...
        .set("setposition", {
          run: async (d, position) => {
            ...
            if (isNaN(position) || Number(position) < 1)
              return new d.error("invalid", d, "position", position);
