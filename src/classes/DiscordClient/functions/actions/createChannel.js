...
module.exports = {
  ...
  parameters: [
    ...
    },
    {
      name: "Options",
      description:
        "The options to create channel. Read #(createChannel) in HyteScript Docs for more details.",
      optional: "true",
      defaultValue: "none",
    },
    {
  ...
  run: async (
    ...
    if (getType == undefined)
      return new d.error("invalid", d, "channel type", type);
      ...
      optionsData.functions = new Functions(optionsData.functions)
        ...
        .set("setbitrate", {
          run: async (d, bitrate) => {
            ...
            if (obj.type !== ChannelType.GuildVoice)
              return new d.error(
                "custom",
                d,
                "that function can only be used with voice channel type",
              );
        ...
        .set("setslowmode", {
          run: async (d, time) => {
            ...
            if (obj.type !== ChannelType.GuildText)
              return new d.error(
                "custom",
                d,
                "that function can only be used with text channel type",
              );
