...
module.exports = {
    ...
    parameters: [
        ...
        {
            name: 'Options',
            description: 'The options to create channel. Read #(createChannel) in HyteScript Docs for more details.',
            optional: 'true',
            defaultValue: 'none'
        },
        {
        ...
        if (typeof options === 'object') {
            ...
            optionsData.functions = new Functions(optionsData.functions).set('settopic', { 
                ...
                run: async (d, bitrate) => {
                    ...
                    if (obj.type !== ChannelType.GuildVoice) return new d.error("custom", d, 'that function can only be used with voice channel type')
                ...
                run: async (d, time) => {
                    ...
                    if (obj.type !== ChannelType.GuildText) return new d.error("custom", d, 'that function can only be used with text channel type')
