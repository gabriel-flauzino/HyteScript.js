...
module.exports = async (d) => {
  d.client.on("interactionCreate", async (interaction) => {
    ...
    if (interaction.isChatInputCommand()) {
      ...
      let commandData = d.commandManager.commandInteraction.get(
        interaction.commandName.toLowerCase(),
      );
      if (!commandData)
        commandData = d.commandManager.commandInteraction.get(
          interaction.commandName.toLowerCase() +
    ...
    if (interaction.isButton()) {
      ...
      const commandData = d.commandManager.buttonInteraction.get(
    ...
    if (interaction.isSelectMenu()) {
      ...
      const commandData = d.commandManager.selectMenuInteraction.get(
        interaction.customId.toLowerCase(),
      );
      if (!commandData) return;
    ...
    if (interaction.isMessageContextMenuCommand()) {
      ...
      const commandData = d.commandManager.messageContextMenuInteraction.get(
        interaction.commandName.toLowerCase(),
      );
      if (!commandData) return;
    ...
    if (interaction.isUserContextMenuCommand()) {
      ...
      const commandData = d.commandManager.userContextMenuInteraction.get(
        interaction.commandName.toLowerCase(),
      );
      if (!commandData) return;
    ...
    if (interaction.isModalSubmit()) {
      ...
      const commandData = d.commandManager.modalSubmitInteraction.get(
        interaction.customId.toLowerCase(),
      );
      if (!commandData) return;
    ...
    if (interaction.isAutocomplete()) {
      ...
      const commandData = d.commandManager.autocompleteInteraction.get(
        interaction.commandName.toLowerCase(),
      );
      if (!commandData) return;
