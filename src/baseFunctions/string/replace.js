...
module.exports = {
  ...
  parameters: [
    ...
    },
    {
      name: "How many",
      description:
        'How many times to replace search to replacer. Can be used "all", which will replace all searchs and negative numbers, which will make it replaces last searchs first.',
      optional: "true",
      defaultValue: "all",
    },
  ],
  run: async (d, string, search, replacer, howmany = "all") => {
    ...
    if (isNaN(howmany) && howmany.toLowerCase() !== "all")
      return new d.error("invalid", d, "how many number", howmany);
