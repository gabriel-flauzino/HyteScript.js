module.exports = {
  description:
    "Crops chars which exceeds provided max length. Returns cropped string + provided suffix (text in the end).",
  ...
  run: async (d, string, maxLength, suffix = "...") => {
    ...
    if (isNaN(maxLength) || Number(maxLength) < 1)
      return new d.error("invalid", d, "max length", maxLength);
