...
module.exports = {
  ...
  parameters: [
    ...
    },
    {
      name: "Condition",
      description:
        "The condition to filter properties. Use {objProperty} for get the property, and {objValue} for get it value.",
      optional: "false",
      defaultValue: "none",
    },
    {
      name: "Text to return",
      description:
        "Text to be returned for each filtered property. Use {objProperty} for get the property, and {objValue} for get it value.",
      optional: "false",
      defaultValue: "none",
    },
    {
