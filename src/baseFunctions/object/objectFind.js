...
module.exports = {
  description:
    "Finds an object property which meets condition. Returns nothing when no property meets condition.",
  ...
  parameters: [
    ...
    },
    {
      name: "Condition",
      description:
        "The condition to find property. Use {objProperty} for get the property, and {objValue} for get it value.",
      optional: "false",
      defaultValue: "none",
    },
    {
      name: "Text to return",
      description:
        "Text to be returned for found property. Use {objProperty} for get the property, and {objValue} for get it value.",
      optional: "false",
      defaultValue: "none",
    },
  ],
  ...
  run: async (d, name, condition, textToReturn) => {
    ...
    if (textToReturn == undefined)
      return new d.error("required", d, "text to return");
    ...
    for (const property in d.data.objects[name]) {
      if (
        Object.prototype.hasOwnProperty.call(d.data.objects[name], property)
      ) {
