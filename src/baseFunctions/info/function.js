module.exports = {
  ...
  run: async (d, func, property) => {
    if (func == undefined) return new d.error("required", d, "func");
    ...
    if (property.toLowerCase() === "exists") return getFunction != undefined;
      ...
      return new d.error("invalid", d, "function name", func);
    ...
    if (prop == undefined)
      return new d.error("invalid", d, "function property", property);
