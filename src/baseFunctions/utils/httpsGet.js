...
module.exports = {
  ...
  parameters: [
    ...
    },
    {
      name: "Headers",
      description:
        "The request headers. Read #(httpsGet) in HyteScript wiki for detailed explanation.",
      optional: "true",
      defaultValue: "none",
    },
  ],
  ...
  run: async (d, link, property, headers) => {
    ...
    if (typeof headers === "object") {
      ...
      headersData.functions = new BaseFunctions(
        { getDirFiles, replaceLast, clone },
        headersData.functions,
      )
        .set("addheader", {
    ...
    let response = await get(link, { headers }).catch(
