...
module.exports = {
  description:
    "Executes a code asynchronously, which means that the code which called that function will not wait for it execution to finish. Supports #(break) to stop it execution.",
  usage: "code",
  parameters: [
    {
      name: "Code",
